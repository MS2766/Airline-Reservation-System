...
if(!isset($_SESSION['user_id']) && !empty($_COOKIE['rememberme'])){
    ...
    //   extract $authentificators 1&2 fromlthe cookie
...
if($count !== 1){
    ...
    if(!hash_equals($row['f2authentificator2'], $f2authentificator2)){
     ...
     //    Log the user in and redirect to notes page -- >
        ...
        header("location:2.mainpageloggedin.php");
    }
}
//else{
  //  echo '<div class="alert alert-danger" style="margin-yop:50px">User_id: ' . $_SESSION['user_id'] . '</div>';
